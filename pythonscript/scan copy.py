...
def send_replay_request(pickup_id, student_id, student_name):
    try:
...
def replay_pickup_selected(treeview, audio_queue, conn):
    ...
    for item in selected_items:
        ...
        try:
            ...
            # Send replay request to Flask API with pickup_id
            send_replay_request(pickup_id, student_id, student_name)
        except Exception as e:
